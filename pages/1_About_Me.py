...
st.write("Currently, I'm immersed in the world of software development, transforming ideas into vibrant tech solutions. Whether it's crafting sleek websites, optimizing code for AI magic, or diving into the latest tech trends, I'm all about making the digital realm exciting and user-friendly. Let's build something extraordinary together!")

st.header("What I Used to Do")
st.write("In my past life, I spent over 8 years as a professional tennis coach, shaping the game and personal development of more than 600 students. From empowering beginners to refining strategies for national-level players, each lesson was a unique journey. Transitioning into software engineering, I carry the adaptability and personalized touch from the tennis court into the world of coding, creating tech solutions with a human touch. 🎾💻")
