...
st.write("David Malan offers an accessible entry into the world of programming by teaching Python, a versatile and widely-used programming language known for its readability and flexibility. Python's prominence in artificial intelligence and machine learning applications adds an extra layer of significance to the course, making it an ideal starting point for those aspiring to go into the exciting realms of AI/ML.")

st.markdown("[fast.ai - Practical Deep Learning](https://course.fast.ai/)")
st.write("Created by Jeremy Howard and Rachel Thomas, the fast.ai course begins with offering a more hands-on approach by using AI tools in real-world examples before explaining how the tools work.")
...
st.write("Andrej Karpathy's series of lectures describe the evolution of language modeling and how to build different architectural models from scratch to give a better understanding of the intricacies of modern language models.")

st.markdown("[DeepLearning.AI Short Courses](https://www.deeplearning.ai/short-courses/)")
st.write("DeepLearning.AI covers various aspects of generative AI and is an excellent resource for both beginners and those looking to deepen their knowledge in the field.")
...
st.write("Speakers Colin Jarvis and Luv Kothari emphasize the power of optimizing and fine-tuning LLMs for critical use cases to meet industry demands. They provide insights into the strategic balance (and difference) between retrieval augmented generation for content enrichment, and fine-tuning to enhance the model's capabilities. The presentation serves as a valuable guide for enterprises to ensure proficiency and confidence in harnessing transformative LLM capabilities.")
